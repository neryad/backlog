...
By downloading or using Playlogged, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the app.

These terms apply to all users of Playlogged on iOS and Android.

---

## 2. Description of Service

Playlogged is a free, offline-first game backlog tracker. It allows you to:

- Organize your personal game library by status (Backlog, Playing, Completed, Dropped, Wishlist)
- Search for games using the IGDB database
- Log personal ratings, notes, and hours played
- View stats about your gaming habits

The app is provided free of charge for personal, non-commercial use.

---

## 3. User Responsibilities

You agree to use Playlogged only for lawful purposes and in accordance with these Terms. You are responsible for any content you enter into the app, including notes and game entries.
...
- Exploit or abuse external APIs accessed by the app (e.g., IGDB)

---

## 4. Intellectual Property

Playlogged and its original code, design, and branding are the intellectual property of **Neryad** and are protected by applicable copyright laws.

**Game data** (titles, cover artwork, descriptions, release dates) is sourced from [IGDB](https://www.igdb.com), a service operated by Twitch Interactive, Inc. All game-related content belongs to their respective publishers and developers. Playlogged makes no claim of ownership over any game data.

You may not reproduce, distribute, or commercially exploit any content from Playlogged without appropriate authorization from the respective rights holders.

---

## 5. Third-Party Links

Playlogged contains links to external websites and services, including:

- [IGDB](https://www.igdb.com) — game data
- [Ko-fi](https://ko-fi.com) and [PayPal](https://www.paypal.com) — optional developer support
- Social media profiles

These links are provided for your convenience. **Neryad** has no control over the content or practices of these third-party sites and accepts no responsibility for them. We encourage you to review their terms and privacy policies before interacting with them.

---

## 6. Disclaimer of Warranties

Playlogged is provided **"as is"** and **"as available"**, without warranties of any kind, either express or implied.

**Neryad** does not warrant that:

- The app will be error-free or uninterrupted
- Game data from IGDB will always be accurate or up to date
...
To the fullest extent permitted by applicable law, **Neryad** shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of — or inability to use — Playlogged.

This includes, but is not limited to, loss of data stored in the app (e.g., due to device failure or app deletion). Since all data is stored locally on your device, we strongly recommend making regular backups of your device.

Our total liability to you for any claims related to the app shall not exceed the amount you paid for the app (which is zero, as it is free).
...
We reserve the right to update these Terms of Service at any time. Changes will be indicated by an updated "Last updated" date at the top of this document.

Your continued use of Playlogged after any changes constitutes your acceptance of the revised terms.
